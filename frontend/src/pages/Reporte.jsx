...
const s = {
  ...
  statLabel:{fontFamily:'var(--font-mono)',fontSize:'0.65rem',color:'#cccccc',letterSpacing:'0.15em'},
  sectionTag:{fontFamily:'var(--font-mono)',fontSize:'0.68rem',color:'#cccccc',letterSpacing:'0.15em',display:'block',marginBottom:'14px'},
